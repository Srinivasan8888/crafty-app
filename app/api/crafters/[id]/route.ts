...
export async function PATCH(req: NextRequest, { params }: { params: { id: string } }) {
  ...
  const updated = await prisma.crafter.update({
    ...
    data: {
      ...
      ...(data.profile_photo_blurhash !== undefined && { profile_photo_blurhash: data.profile_photo_blurhash || null }),
      ...(data.portfolio_photos !== undefined && { portfolio_photos: data.portfolio_photos }),
      ...(data.portfolio_blurhashes !== undefined && { portfolio_blurhashes: data.portfolio_blurhashes }),
